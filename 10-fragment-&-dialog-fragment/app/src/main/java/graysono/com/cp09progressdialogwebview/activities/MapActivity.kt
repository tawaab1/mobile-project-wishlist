...
import graysono.com.cp09progressdialogwebview.custom.CustomToast
import graysono.com.cp09progressdialogwebview.helpers.MapsStudio
import graysono.com.cp09progressdialogwebview.helpers.MarkerCluster
import graysono.com.cp09progressdialogwebview.helpers.putDouble
...
class MapActivity : BaseActivity(), OnMapReadyCallback {
    ...
    private lateinit var clusterManager: ClusterManager<MapsStudio>
    private lateinit var markerCluster: MarkerCluster
    private lateinit var customToast: CustomToast
    private lateinit var recordingStudioData: ArrayList<MapsStudio>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_map)
        displayToolbar(isHomeEnabled = true, isTitleEnabled = true)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        recordingStudioData = arrayListOf(
            ...
            MapsStudio("Sunset Sound", LatLng(34.0977818, -118.3349175), "https://www.sunsetsound.com"),
            MapsStudio("MIX Recording Studio", LatLng(34.0628191, -118.281333), "https://mixrecordingstudio.com"),
            MapsStudio("Silverlake Recording Studios", LatLng(34.089849, -118.281676), "http://silverlakerecordingstudios.com"),
            MapsStudio("Studio City Sound", LatLng(34.1508032, -118.404879), "https://www.studiocitysound.com"),
            MapsStudio("7th Street Sound", LatLng(34.0352197, -118.2295421), "N/A"),
            MapsStudio("Prairie Sun Recording Studio", LatLng(38.3298996, -122.7287277), "https://www.prairiesun.com"),
            MapsStudio("Pus Cavern Recording Studio", LatLng(38.649085, -121.357698), "https://www.puscavern.com"),
            MapsStudio("The Press Recording Studio", LatLng(37.95287990000001, -121.2872891), "https://www.thepressrecordingstudio.com"),
            MapsStudio("Red Eye Recording Studios", LatLng(37.3583901, -121.8448954), "https://www.redeyerecordingstudios.com"),
            MapsStudio("Uprise Recording", LatLng(38.60463439999999, -121.463057), "https://upriserecording.com"),
            // Recording studios in the state of Florida
            MapsStudio("Clear Track Recording Studios", LatLng(27.9631844, -82.7949981), "https://www.cleartrackstudios.com"),
            MapsStudio("Phantom City Studio", LatLng(28.4320156, -81.5083995), "https://www.phantomcitystudio.com"),
            MapsStudio("Phat Planet Recording Studios", LatLng(28.6005069, -81.4202577), "http://phatplanetstudios.com"),
            MapsStudio("Trunoyz Recording Studios", LatLng(26.1939945, -80.2024307), "http://trunoyz.com"),
            MapsStudio("Stay Tuned Studios", LatLng(30.18589890000001, -81.5707087), "http://www.staytunedstudios.com"),
            // Recording studios in the state of Illinois
            MapsStudio("Eclipse Studios", LatLng(40.5470674, -88.99286719999999), "https://www.eclipsestudios.net"),
            MapsStudio("Earhole Studios", LatLng(41.89067060000001, -87.62849519999999), "http://earholestudios.com"),
            MapsStudio("Stonecutter Recording Studio", LatLng(41.858128, -87.640474), "http://www.stonecutterstudios.com"),
            MapsStudio("Barker Recording Studio", LatLng(42.26636899999999, -89.057958), "https://barkerrecordingstudio.com"),
            MapsStudio("Gremlen Recording Studios", LatLng(41.7586331, -88.3192086), "https://www.gremlenstudios.com")
        )
